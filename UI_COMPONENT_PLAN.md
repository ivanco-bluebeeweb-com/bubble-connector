# Bubble Connector — UI Component Plan
...
- **Центральная зона:** Карточки статуса подключения, таблица сущностей (объекты базы данных Data API (/obj/{typename})), журнал операций.
