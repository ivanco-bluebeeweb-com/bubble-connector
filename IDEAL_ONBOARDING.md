# Bubble Connector — Ideal Onboarding & First Launch

**Compliance:** ONBOARDING_FIRST_LAUNCH_STANDARD.md

## Шаги онбординга
1. **Экран первого запуска:** Назначение коннектора Bubble и требования к правам доступа.
2. **Ввод учетных данных:** Форма с явными лейблами, валидацией формата и подсказкой для получения ключа.
3. **Проверка подключения:** Немедленный вызов `GET /api/1.1/meta` с отображением статуса.
