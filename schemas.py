"""Pydantic schemas for Bubble Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Bubble.")
    api_token: str = Field(description="Platform API Key / Access Token")
    base_url: str = Field(default="https://api.bubble.io/v1", description="Bubble API base URL.")
...
class GetAppRecordParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    apprecord_id: str = Field(description="Bubble AppRecord ID.")
